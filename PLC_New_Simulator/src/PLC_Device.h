...
uint32 PLC_DEVICE_getOffsetDeviceValue(uint8 operand[], uint16 offset);
uint32 PLC_DEVICE_getOffsetPastDeviceValue(uint8 operand[], uint16 offset);
uint8 PLC_DEVICE_getOffsetDeviceWordValue(uint16* tar, uint8 operand[], uint16 offset);
uint32 PLC_DEVICE_getOffsetDeviceNibbleValue(uint8 operand[], uint16 offset);
uint8 PLC_DEVICE_getOffsetDeviceDoubleWordValue(uint32* tar, uint8 operand[], uint16 offset);
float PLC_DEVICE_getOffsetDeviceFloatValue(uint8 operand[], uint16 offset);
double PLC_DEVICE_getOffsetDeviceDoubleValue(uint8 operand[], uint16 offset);

uint8 PLC_DEVICE_isDeviceAddrRange(uint8 operand[], uint16 addrOffset);
...
uint8 PLC_DEVICE_increaseStep(uint8 result);
