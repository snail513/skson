...
uint8 addMLFile(char* MLFilePathName, uint8 taskIdx, uint32 crc){
	...
	if(!rst)
		DBG_LOGPRINT("crc check : rst : %d | exp = %d\n", crc16(stackML, fsize), crc);
	free(stackML);
	//DBG_LOGPRINT("[%s] [%d]\n", __func__, __LINE__);
...
/*
extern void testSequenceCommand(void);
extern void testSequenceWB2BRCommand(void);
extern void testSequenceWB2WBCommand(void);
extern void testSequenceCommandExtra(void);

extern void testBasicCompareWordCommand(void);
extern void testBasicCompareWordNibbleCommand(void);
extern void testBasicCompareWordIndexCommand(void);
extern void testBasicCompareDWordCommand(void);
extern void testBasicCompareDWordNibbleCommand(void);
extern void testBasicCompareDwordIndexCommand(void);
extern void testBasicCompareFloatCommand(void);
extern void testBasicCompareFloatIndexCommand(void);
extern void testBasicCompareDoubleCommand(void);
extern void testBasicCompareDoubleIndexCommand(void);
extern void testBasicCompareStringCommand(void);
extern void testBasicCompareWordBlockCommand(void);
extern void testBasicCompareDWordBlockCommand(void);

extern void testBasicArithmeticWordCommand(void);
extern void testBasicArithmeticWordNibbleCommand(void);
extern void testBasicArithmeticWordIndexCommand(void);
extern void testBasicArithmeticDWordCommand(void);
extern void testBasicArithmeticDWordNibbleCommand(void);
extern void testBasicArithmeticDWordIndexCommand(void);
extern void testBasicArithmeticFloatCommand(void);
extern void testBasicArithmeticFloatIndexCommand(void);
extern void testBasicArithmeticMulCommand(void);
extern void testBasicArithmeticMulNibbleCommand(void);
extern void testBasicArithmeticMulIndexCommand(void);
extern void testBasicArithmeticDWordMulCommand(void);
extern void testBasicArithmeticDWordMulNibbleCommand(void);
extern void testBasicArithmeticDWordMulIndexCommand(void);
extern void testBasicArithmeticStringCommand(void);
extern void testBasicArithmeticBlockCommand(void);

extern void testConversionWordCommand(void);
extern void testConversionWordNibbleCommand(void);
extern void testConversionWordIndexCommand(void);
extern void testConversionDWordCommand(void);
extern void testConversionDWordNibbleCommand(void);
extern void testConversionDWordIndexCommand(void);
extern void testConversionFloatCommand(void);
extern void testConversionFloatIndexCommand(void);
extern void testConversionExtraCommand(void);

extern void testTransferWordCommand(void);
extern void testTransferWordNibbleCommand(void);
extern void testTransferWordIndexCommand(void);
extern void testTransferDWordCommand(void);
extern void testTransferDWordNibbleCommand(void);
extern void testTransferDWordIndexCommand(void);
extern void testTransferBlockCommand(void);
extern void testTransferExtraCommand(void);

extern void testControlCommand(void);

extern void testRuntimeErrorSequence(void);
extern void testRuntimeErrorWD(void);
extern void testRuntimeErrorDW(void);
extern void testRuntimeErrorFloat(void);
extern void testRuntimeErrorBlock(void);
extern void testRuntimeErrorExtra(void);
*/
extern uint8 ATest_Srch();
extern uint8 ATest_Sum();
extern uint8 ATest_Max();
extern uint8 ATest_Min();
extern uint8 ATest_Mean();
extern uint8 ATest_Sort();
extern uint8 ATest_Limit();
extern uint8 ATest_Band();
extern uint8 ATest_Zone();
extern uint8 ATest_Daterd();
extern uint8 ATest_Second();
extern uint8 ATest_Hour();

extern uint8 ATest_DAToB();
extern uint8 ATest_HAToB();
extern uint8 ATest_BToDA();
extern uint8 ATest_BToHA();
extern uint8 ATest_Len();
extern uint8 ATest_Rotation();
extern uint8 ATest_BtoStr();
extern uint8 ATest_StrToB();
extern uint8 ATest_BToAsc();
extern uint8 ATest_AscToB();

extern uint8 AT_forNext();
extern uint8 AT_forNextBreak();
...
/*
	...
	CU_add_test(pSuite, "Additional Test::SRCH(P)", ATest_Srch);
	CU_add_test(pSuite, "Additional Test::CHKSUM(P)", ATest_Sum);
	CU_add_test(pSuite, "Additional Test::MAX(P)", ATest_Max);
	CU_add_test(pSuite, "Additional Test::MIN(P)", ATest_Min);
	//CU_add_test(pSuite, "Additional Test::MEAN", ATest_Mean);
	CU_add_test(pSuite, "Additional Test::SORT(P)", ATest_Sort);
	CU_add_test(pSuite, "Additional Test::LIMIT(P)", ATest_Limit);
	CU_add_test(pSuite, "Additional Test::BAND(P)", ATest_Band);
	CU_add_test(pSuite, "Additional Test::ZONE(P)", ATest_Zone);

	CU_add_test(pSuite, "Additional Test::SECOND(P)", ATest_Second);
	CU_add_test(pSuite, "Additional Test::HOUR(P)", ATest_Hour);
	CU_add_test(pSuite, "Additional Test::DATOB(P)", ATest_DAToB);
	CU_add_test(pSuite, "Additional Test::HATOB(P)", ATest_HAToB);
	CU_add_test(pSuite, "Additional Test::BTODA(P)", ATest_BToDA);
	CU_add_test(pSuite, "Additional Test::BTOHA(P)", ATest_BToHA);
	CU_add_test(pSuite, "Additional Test::For-Next", AT_forNext);
	CU_add_test(pSuite, "Additional Test::For-Next-Break", AT_forNextBreak);
	CU_add_test(pSuite, "Additional Test::For-Next-Break", ATest_Len);
	CU_add_test(pSuite, "Additional Test::For-Next-Break", ATest_Rotation);
	CU_add_test(pSuite, "Additional Test::BtoStr", ATest_BtoStr);
	CU_add_test(pSuite, "Additional Test::StrToB", ATest_StrToB);
	CU_add_test(pSuite, "Additional Test::StrToB", ATest_BToAsc);
	CU_add_test(pSuite, "Additional Test::StrToB", ATest_AscToB);
	CU_add_test(pSuite, "Additional Test::DATERD(P)", ATest_Daterd);
...
void setTimerLD(){
	...
	addMLOperator(ML_CODE_SECOND);
	addMLOperand(OPERAND_ML_CODE_D, 0);
	addMLOperand(OPERAND_ML_CODE_D, 10);
	//addMLOperand(OPERAND_ML_CODE_D, 15);
	//addMLOperand(OPERAND_ML_CODE_K, 4);
	//addMLOperand(OPERAND_ML_CODE_K, 0);
	//addMLOperand(OPERAND_ML_CODE_K, 10);
	//addMLOperand(OPERAND_ML_CODE_K, 10);
...
void setTimerInput(){
	...
	addDeviceControlInstruction(0, OPERAND_ML_CODE_D, 0, 10);
	addDeviceControlInstruction(0, OPERAND_ML_CODE_D, 1, 23);
	addDeviceControlInstruction(0, OPERAND_ML_CODE_D, 2, 50);
	//addDeviceControlInstruction(0, OPERAND_ML_CODE_D, 1, 2);
	addDeviceControlInstruction(0, OPERAND_ML_CODE_D, 15, 4);
	//addDeviceControlInstruction(0, OPERAND_ML_CODE_D, 20, 3);
	//addDeviceControlInstructionToString(0, OPERAND_ML_CODE_D, 0, "1456A89034\0");
	TestCodeTearDown();
}
//todo
