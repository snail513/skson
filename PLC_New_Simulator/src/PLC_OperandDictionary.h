...
#define OPERAND_ML_CODE_SB 22
#define OPERAND_ML_CODE_J 23
#define OPERAND_ML_CODE_U 24
#define OPERAND_ML_CODE_Zin 25
#define OPERAND_ML_CODE_MAX 26
#define OPERAND_ML_CODE_FUNC_OP 0xFF
...
static const PLC_Operand opndic[]={
			...
			,{OPND_DIC_SYMBOL_DE, 0, 	TRUE, OPND_DIC_TYPE_LONG, OPERAND_ML_CODE_DE}
			...
			,{OPND_DIC_SYMBOL_SB, 2048,	FALSE, OPND_DIC_TYPE_BIT, OPERAND_ML_CODE_SB}
			,{OPND_DIC_SYMBOL_J, 0,	FALSE, OPND_DIC_TYPE_WORD, OPERAND_ML_CODE_J}
			,{OPND_DIC_SYMBOL_U, 0,	FALSE, OPND_DIC_TYPE_WORD, OPERAND_ML_CODE_U}
			,{OPERAND_ML_CODE_Zin, 0,	FALSE, OPND_DIC_TYPE_WORD, OPERAND_ML_CODE_Zin}
